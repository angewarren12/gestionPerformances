						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Modifier Employe</li>
								</ul>
							</div>
						</div>
					</div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card mb-0">
                                                <div class="card-header">
                                                    <h4 class="card-title mb-0">Modifier Employe</h4>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{route('update.employe',$user->id)}}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="avatar" type="file" value="{{$user->avatar}}" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" name="matricule" type="text" value='{{$user->matricule}}'>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"name="email" type="email" value='' value='{{$user->email}}'>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">  
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="cal-icon"><input class="form-control datetimepicker" type="text" name='date_naissance' value='{{$user->date_naissance}}'> </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select" name="poste" value='{{$user->poste}}'>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select" name="is_admin" value='{{$user->is_admin}}'>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="select" name="sexe" value='{{$user->sexe}}'>
