                ...
                <div class="chat-main-wrapper">
                                    ...
                                    <ul class="nav float-right custom-menu">
                                        <li class="nav-item dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="javascript:void(0)">Toutes les taches</a>
                                                <a class="dropdown-item" href="javascript:void(0)">Taches en attente</a>
                                                <a class="dropdown-item" href="javascript:void(0)">Taches terminé</a>
                                                ...
                                                <div class="task-list-container">
                                                    <div class="task-list-body">
                                                        <ul id="task-list">
                                                           ...
                                                           @foreach ($tacheListe as $tacheListes)
                                                               ...
                                                               <li class="task">
                                                                <div class="task-container">
                                                                    ...
                                                                    <span class="task-label" contenteditable="true">{{ $tacheListes->libele }}</span>
                                                                    <span class="task-label" contenteditable="false">{{ $tacheListes->libele }}</span>
                    ...
                    <div class="col-lg-5 message-view task-chat-view task-right-sidebar" id="task_window">
                        <div class="chat-window">
                            ...
                            @foreach ($tacheListeByObjectif as $tacheListeByObjectifs)
                            ...
                            <div class="chat-contents task-chat-contents">
                                <div class="chat-content-wrap">
                                    <div class="chat-wrap-inner">
                                        <div class="chat-box">
                                            <div class="chats">
                                                <h4>{{ $tacheListeByObjectifs->titre }}</h4>
