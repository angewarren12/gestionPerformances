        ...
        <div class="main-wrapper">
           ...
           @include('partials.sidebar')
            ...
            <div class="page-wrapper">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="{{route('ajout.employe')}}" class="btn add-btn" ><i class="fa fa-plus"></i> Add Employee</a>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<a href="profile.html" class="avatar"><img src="{{$employes->avatar}}" alt=""></a>
								</div>
								<div class="dropdown profile-action">
									<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
									<div class="dropdown-menu dropdown-menu-right">
										<form  action="{{route('delete.employe',$employes->id)}}" method="POST">
											<a class="dropdown-item" href="{{route('edit.employe',$employes->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
										
											@csrf
											@method('DELETE')
											<button class=" dropdown-item "type="submit"><i class="fa fa-trash-o m-r-5"></i> Supprimer</button>
										</form>
									</div>
								</div>
				...
				<!-- Add Employee Modal -->
				<div id="" class=" custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Add Employe</h5>
							...
							<div class="modal-body">
								...
								<form action="{{route('create.employe')}}" method="POST">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												<label class="col-form-label" name="poste">Poste</label>
												<select class="select">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Role <span class="text-danger" name="role">*</span></label>
												<select class="select">
