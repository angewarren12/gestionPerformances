									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="#"><img alt="" src="{{$user->avatar}}"></a>
											</div>
										</div>
						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									...
									<li class="nav-item"><a href="#emp_projects" data-toggle="tab" class="nav-link">Objectifs</a></li>
										...
										<div class="card-body">
											...
											<ul class="personal-info">
												<li>
													...
													<div class="text">{{ $user->poste }}</div>
												</li>
												<li>
													<div class="title">Contact:</div>
															<div class="text"><a href="">{{ $user->contact }}</a></div>
												</li>
												<li>
												...
												<li>
													...
													<div class="text">{{ $user->date_naissance }}</div>
												</li>
												<li>
								...
								<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
									<div class="card">
										<div class="card-body">
											...
											<h4 class="project-title"><a href="project-view.html">{{ $objectifs->titre }}</a></h4>
											<small class="block text-ellipsis m-b-15">
												<span class="text-xs">1</span> <span class="text-muted">taches ouvertes , </span>
												<span class="text-xs">9</span> <span class="text-muted">taches completées</span>
											</small>
											...
											<div class="project-members m-b-15">
												...
												<ul class="team-members">
													@foreach ($emp_obj as $emp_objs )
													<li>
														<a href="#" data-toggle="tooltip" title=""><img alt="" src="{{ asset('assets/img/profiles/avatar.png') }}"></a>
													</li>
