...
<html lang="en">
    <head>
        ...
        <title>{{ config('app.name', 'Gestion des performances') }}</title>
           ...
           @include('partials.sidebar')
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md- col-sm-6 col-lg-6 col-xl-4">
                    ...
                    <div class="row">
                            ...
                            <div class="card flex-fill">
                                <div class="card-body">
                                    ...
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-purple" role="progressbar" style="width: 50%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">30%</div>
                                        ...
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 28%" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100">24%</div>
                                        </div>
                                    <div>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body">
                                    <h4 class="card-title">Prochaine Reunion <span class="badge bg-inverse-danger ml-2">5</span></h4>
